...
/workspace/conda_env/llava-raw/bin/python -m llava.eval.model_vqa_loader \
    ...
    --answers-file ./playground/data/eval/vizwiz/answers/0831-tokenpacker-retrain-llava1-1-3.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1

/workspace/conda_env/llava-raw/bin/python scripts/convert_vizwiz_for_submission.py \
    --annotation-file ./playground/data/eval/vizwiz/llava_test.jsonl \
    --result-file ./playground/data/eval/vizwiz/answers/0831-tokenpacker-retrain-llava1-1-3.jsonl \
    --result-upload-file ./playground/data/eval/vizwiz/answers_upload/0831-tokenpacker-retrain-llava1-1-3.json
